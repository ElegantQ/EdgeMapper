...
/**
 * Created by rongshuai on 2020/7/14 17:57
 */
public class Constants {
    ...
    public static String TbTelemetryTopic ="v1/devices/me/telemetry";

    public static String BleWatchToken = "ler8EtBDnnCdq6BWP7fB";
}
